...
<body>
    ...
    <section class="services">
        <div class="container border-header">
            <div class="header">                
                ...
                <p class="desc text-orange">From our truckage</p>
            </div>
            <div class="blocks">
                <div class="item">
    ...
    <!--DELECTUS-->
    <section class="delectus">
        <div class="container">
            <h3 class="main-title">hic tenetur a sapiente delectus</h3>
            <div class="content">
                <div class="item">
                    <div class="text">
                        <h4 class="title">
                        ...
                        <p class="desc">Nemo enim ipsam voluptatem quia voluptas sit aspernatur.</p>
                    </div>
                    <div class="number">
                        <div class="circle">
                            <span>01.</span>
    ...
    <section class="spec-services">
        <div class="container border-header">
            <div class="header">                
                <h2 class="title">special services</h2>
                <p class="desc text-orange">From our truckage</p>
            </div>
            <div class="content">
                <div class="item">
                    ...
                    <div class="title text-orange">Nemo enim ipsam voluptatem quia voluptas sit aspernatur</div>
                    <div class="button animate-btn">Read more</div>
                </div>
                <div class="item">
                    <div class="image">
                        <img src="img/9.jpg" alt="">
