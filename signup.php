    ...
    <section class="login signup">
        <div class="container border-header">
            ...
            <form action="" class="loginForm" method="POST">
                <input type="text" class="user p10" placeholder="User Name" required>
                <input type="text" class="email p10" placeholder="Email" required>
                <input type="password" class="pass p10" placeholder="********" required>
                    <span class="check-box">
                        <input type="checkbox" name="accept">
                        <label for="accept">I accept terms</label>
                    </span>
